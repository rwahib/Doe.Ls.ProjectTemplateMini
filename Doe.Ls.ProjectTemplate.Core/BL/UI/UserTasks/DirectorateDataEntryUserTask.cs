...
{
    public class DirectorateDataEntryUserTask : UserTaskBase
    {
        public DirectorateDataEntryUserTask(IRepositoryFactory factory, UserInfoExtension user) :
            base(factory, user, Enums.UserRole.DirectorateDataEntry, Enums.UserRole.DirectorateDataEntry.ToString(), Enums.UserRole.DirectorateDataEntry.GetDescription())
        {
        }

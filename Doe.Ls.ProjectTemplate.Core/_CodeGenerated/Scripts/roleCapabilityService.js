    ...
    return {
        ...
        dtSettings: {
            ...
            'aoColumns': [
                ...
                {'sName':'Highlighted','mData':'Highlighted' },
                {
                    'sName':'DateCreated',
                    'mData': 'DateCreated',
                ...
                {'sName':'LastModifiedBy','mData':'LastModifiedBy', 'defaultContent': ''  },
                {
                    ...
                    'mRender': function(code){
                        return '<div class="btn-group-vertical">' + 
                                    '<a href="RoleCapability/Edit?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Edit</a>' + 
                                    '<a href="RoleCapability/Details?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Detail</a>' + 
                                    '<a href="RoleCapability/Delete?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Delete</a>' + 
                                '</div>';
                    },
                    'bSortable': false
                }

...
namespace Doe.Ls.ProjectTemplate.Core.BL.EntityRepositories 
{
    public partial class OrgLevelRepository : BaseRepository<OrgLevel> 
    {
        ...
        {                       
            return base.List().Where(ol=>ol.OrgLevelId!=Enums.Cnt.Na)                    
        ...
        public OrgLevel GetOrgLevelById(int orgLevelId)
        {
            return List().SingleOrDefault(l => l.OrgLevelId == orgLevelId);
        }
    }
}

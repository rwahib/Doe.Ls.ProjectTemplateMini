...
define(['jquery', 'cnt', 'helper', 'interactive', 'api', 'fValidator'], function ($, cnt, helper, interactive, api) {
    ...
    return {
        ...
        dtSettings: {
            'iDisplayLength': 10,
            'aoColumns': [
                {'sName':'PositionHistoryId','mData':'PositionHistoryId' },
                ...
                {
                    'mData': 'PositionHistoryId',
                    'mRender': function(code){
                        return '<div class="btn-group-vertical">' + 
                                    '<a href="PositionHistory/Edit?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Edit</a>' + 
                                    '<a href="PositionHistory/Details?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Detail</a>' + 
                                    '<a href="PositionHistory/Delete?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Delete</a>' + 
                                '</div>';
                    },
                    'bSortable': false
                }

...
define(['jquery', 'cnt', 'helper', 'interactive', 'api', 'fValidator'], function ($, cnt, helper, interactive, api) {
    ...
    return {
        ...
        dtSettings: {
            'iDisplayLength': 10,
            'aoColumns': [
                {'sName':'PositionNoteId','mData':'PositionNoteId' },
                ...
                {
                    'mData': 'PositionNoteId',
                    'mRender': function(code){
                        return '<div class="btn-group-vertical">' + 
                                    '<a href="PositionNote/Edit?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Edit</a>' + 
                                    '<a href="PositionNote/Details?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Detail</a>' + 
                                    '<a href="PositionNote/Delete?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Delete</a>' + 
                                '</div>';
                    },
                    'bSortable': false
                }

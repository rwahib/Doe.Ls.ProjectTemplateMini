...
namespace Doe.Ls.ProjectTemplate.Core.Test.Domain.Workflow.RoleDescriptionWF
    {
    [TestClass]
//    [Ignore]
...
this.BoolIntegrateWithTrim = false;
        ...
        [TestMethod]
        [Ignore] // create timeout?
        public override void ActionsForDraftTest()
        {
            var roleDescriptionStatus = Enums.StatusValue.Imported;
            var workflowEngine = GetWorkflowEngine(Enums.StatusValue.Draft, roleDescriptionStatus,false);

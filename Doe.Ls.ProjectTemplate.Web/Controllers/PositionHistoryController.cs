    ...
    public partial class PositionHistoryController : AppControllerBase
    {
     ...
     public PositionHistoryRepository Repository
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            {
                throw new HttpException($"The position ({id}) history not found.");
            }
         ...
         public ActionResult ListJson([FromUri] JQueryDataTableParamModel arg) 
         {
            ...
            try
            {
                var positionHistorys = Repository.List().AsNoTracking();
        ...
        public ActionResult Delete(int id = 0)
        {
            ...
            if (positionHistory == null)
            {
                var msg = MessageHelper.NotFoundMessage($"position ({id}) history");

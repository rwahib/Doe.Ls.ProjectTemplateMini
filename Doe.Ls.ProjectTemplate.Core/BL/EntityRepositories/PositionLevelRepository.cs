...
namespace Doe.Ls.ProjectTemplate.Core.BL.EntityRepositories 
{
    public partial class PositionLevelRepository : BaseRepository<PositionLevel> 
    {
        ...
        {                       
            return base.List().Where(ent=>ent.PositionLevelId!=Enums.Cnt.Na)                    
                    .OrderBy(ent=>ent.PositionLevelId);
        }

        public PositionLevel GetPositionLevelById(int positionLevelId)
        {
            return List().SingleOrDefault(pl=>pl.PositionLevelId== positionLevelId);
        }

...
define(['jquery', 'cnt', 'helper', 'interactive', 'api', 'fValidator'], function ($, cnt, helper, interactive, api) {
    ...
    return {
        ...
        dtSettings: {
            'iDisplayLength': 10,
            'aoColumns': [
                { 'sName':'CapabilityNameId','mData':'CapabilityNameId', 'defaultContent': ''},
                { 'sName':'CapabilityLevelId','mData':'CapabilityLevelId', 'defaultContent': ''},
                ...
                {'sName':'LastModifiedBy','mData':'LastModifiedBy', 'defaultContent': ''  },
                {
                    ...
                    'mRender': function(code){
                        return '<div class="btn-group-vertical">' + 
                                    '<a href="CapabilityBehaviourIndicator/Edit?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Edit</a>' + 
                                    '<a href="CapabilityBehaviourIndicator/Details?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Detail</a>' + 
                                    '<a href="CapabilityBehaviourIndicator/Delete?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Delete</a>' + 
                                '</div>';
                    },
                    'bSortable': false
                }

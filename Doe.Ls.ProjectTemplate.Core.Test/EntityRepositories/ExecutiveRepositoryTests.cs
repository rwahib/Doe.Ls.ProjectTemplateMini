...
{
[TestClass]
    public class ExecutiveRepositoryTests : TestBase {
      ...
      [TestMethod]
        public void List()
        {
            ...
            var rep = globalServiceRepository.ExecutiveRepository();
    ...
    {
        string educationServices = Enum.GetName(typeof(Enums.Division), 1);
        string schoolOp = Enum.GetName(typeof(Enums.Division), 2);
        
        Assert.AreEqual("ES", educationServices);
        Assert.AreEqual("TL", schoolOp);
    }

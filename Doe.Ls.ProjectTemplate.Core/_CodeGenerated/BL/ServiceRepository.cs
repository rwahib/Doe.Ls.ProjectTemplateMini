...
namespace Doe.Ls.ProjectTemplate.Core.BL 
{
    public partial class ServiceRepository 
    {
        ...
        public GlobalSettingRepository GlobalSettingRepository(params ResolverOverride[] overrides) 
        {
            return _repositoryFactory.GetService<IRepository<GlobalSetting>>(overrides) as GlobalSettingRepository;
        }
        ...
        public ScriptHistoryRepository ScriptHistoryRepository(params ResolverOverride[] overrides) 
        {
            return _repositoryFactory.GetService<IRepository<ScriptHistory>>(overrides) as ScriptHistoryRepository;
        }

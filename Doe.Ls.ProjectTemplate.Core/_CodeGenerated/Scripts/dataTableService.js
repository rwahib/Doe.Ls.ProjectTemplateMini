...
define(['jquery', 'cnt', 'helper', 'interactive', 'api', 'fValidator'], function ($, cnt, helper, interactive, api) {
    ...
    function applyDataTableSettings(serviceType, callBack){
        switch(serviceType){
            ...
            case 'rolePositionDescriptionHistoryService':

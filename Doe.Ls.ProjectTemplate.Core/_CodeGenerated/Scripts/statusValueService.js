    ...
    return {
        ...
        dtSettings: {
            ...
            'aoColumns': [
                ...
                {'sName':'StatusName','mData':'StatusName', 'defaultContent': ''  },
                {'sName':'StatusDescription','mData':'StatusDescription', 'defaultContent': ''  },
                {
                    'mData': 'StatusId',
                    'mRender': function(code){
                        return '<div class="btn-group-vertical">' + 
                                    '<a href="StatusValue/Edit?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Edit</a>' + 
                                    '<a href="StatusValue/Details?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Detail</a>' + 
                                    '<a href="StatusValue/Delete?id=' + code + '" class="btn btn-primary pop-up"  data-toggle="modal" data-target="#vlePluginModal">Delete</a>' + 
                                '</div>';
                    },
                    'bSortable': false
                }

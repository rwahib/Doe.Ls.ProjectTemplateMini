    ...
    public partial class SysMessageController : AppControllerBase
    {
     ...
     public SysMessageRepository Repository
        ...
        public ActionResult Details(string code = "")
        {
            ...
            var sysMessage = Repository.GetMessageByCode(code);
            if (sysMessage == null)
            {
                throw new HttpException("Message  is not found");
            }
        ...
        public ActionResult Create(SysMessage sysMessage)
        {
            ...
            var propList = sysMessage.UpdateSignature(this.Repository.RepositoryFactory);
        ...
        public ActionResult Edit(SysMessage sysMessage)
        {
            ...
            if (ModelState.IsValid)
            {
                var oldSysMessage = Repository.GetMessageByCode(sysMessage.Code);
